...
import 'package:esol/screens/profile/screen/mainProfile.dart';
...
class _DrawerWidgetState extends State<DrawerWidget> {
    ...
    if (isFork()) {
      return [
        getListTile(I18n.of(context).backup_wallet, () {
          ...
          ExtendedNavigator.named('BusinessesRoutes')
              .push(BusinessesRoutes.showMnemonic);
          // Navigator.push(
          //   context,
  ...
  Widget drawerHeader(DrawerViewModel viewModel) {
    return SvgPicture.asset('assets/images/E-SOL.svg');
  }
  //  Widget drawerHeader(DrawerViewModel viewModel) {
  //   return DrawerHeader(
  //     child: Column(
                                  ...
                                  ? Padding(
                                      ...
                                      child: InkWell(
                                        onTap: () {
                                          ...
                                          //         'contactsRouter')
                                          //     .push(
                                          //         ContactsRoutes.profileScreen);
                                          // print(Element.footer().toString());
