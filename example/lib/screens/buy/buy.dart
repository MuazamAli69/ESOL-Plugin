...
import 'package:esol/screens/buy/businessRating.dart';
...
import '../home/widgets/cash_header.dart';
// import '../widgets/custom_send_field.dart';
import '../contacts/widgets/custom_send_field.dart';
        ...
        builder: (_, viewModel) {
          return MainScaffold(
              ...
              newHeaderAppBar: CashHeader(
                scaffoldState: AppKeys.buyPageKey.currentState,
                image: null,
                imageshow: false,
                contactEmpty: true,
                textshow: true,
